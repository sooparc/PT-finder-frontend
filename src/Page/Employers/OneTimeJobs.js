...
const OneTimeJobs = () => {
  ...
  useEffect((index) => {
    ...
    axios.get("http://localhost:3001/onetimejobsdata").then((response) => {
      const newArr = response.data;
  ...
  const saveClickHandler = () => {
    if (isLoggedIn) {
      axios
        .post("http://localhost:3001/onetimejobs", {
          user_id: userId,
          name: name,
  ...
  const editClickHandler = () => {
    axios
      .put("http://localhost:3001/editonetimejob", {
        name: name,
        occupation: occupation,
        salary: salary,
        phone: phone,
      ...
      <div className={classes.container}>
        ...
        <form onSubmit={submitHandler}>
          <div className={classes.inputBox}>
            <div>
              <label className={classes.label}>First name / Last name</label>
              <input
                type="text"
            ...
            <div className="mt-2">
              <label className={classes.label}>When do you need to hire?</label>
              <label
                style={{
                  marginRight: "10px",
                  fontWeight: "700",
